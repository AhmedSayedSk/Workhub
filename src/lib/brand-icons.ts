...
const BRAND_MAP: { keyword: string; slug: string; name: string; color: string }[] = [
  ...
  { keyword: 'caddy', slug: 'caddy', name: 'Caddy', color: '#1F88C0' },
  { keyword: 'next.js', slug: 'nextdotjs', name: 'Next.js', color: '#1A1A1A' },
  { keyword: 'nextjs', slug: 'nextdotjs', name: 'Next.js', color: '#1A1A1A' },
  { keyword: 'fastify', slug: 'fastify', name: 'Fastify', color: '#1A1A1A' },
  { keyword: 'node.js', slug: 'nodedotjs', name: 'Node.js', color: '#5FA04E' },
  { keyword: 'nodejs', slug: 'nodedotjs', name: 'Node.js', color: '#5FA04E' },
  { keyword: 'golang', slug: 'go', name: 'Go', color: '#00ADD8' },
  { keyword: 'go (', slug: 'go', name: 'Go', color: '#00ADD8' },
  { keyword: 'ubuntu', slug: 'ubuntu', name: 'Ubuntu', color: '#E95420' },
  { keyword: 'hetzner', slug: 'hetzner', name: 'Hetzner', color: '#D50C2D' },
  { keyword: "let's encrypt", slug: 'letsencrypt', name: "Let's Encrypt", color: '#003A70' },
  { keyword: 'letsencrypt', slug: 'letsencrypt', name: "Let's Encrypt", color: '#003A70' },
